...
CREATE TABLE TRANSACTIONS (
    ...
    TX_TIME TIMESTAMP,
    MESSAGE VARCHAR(100),
    CONSTRAINT PK_TX PRIMARY KEY (BANKCLIENTID, TX_TIME)
);
/
...
CREATE TABLE ADMIN (
    ...
    ADMINUSERNAME   VARCHAR2(50) UNIQUE,
...
ALTER TABLE TRANSACTIONS ADD CONSTRAINT FK_TX 
    FOREIGN KEY (BANKCLIENTID) REFERENCES BANKCLIENT(BANKCLIENTID);
...
INSERT INTO ACCOUNT(ACCOUNTBALANCE,BANKCLIENTID) VALUES(0.0,1);
