...
INSERT INTO REQUEST (EMPLOYEEID, AMOUNT, REQUESTTIME) VALUES (1, 4.99, TO_TIMESTAMP('2000/3/3 03:03:00', 'YYYY/MM/DD HH:MI:SS'));
INSERT INTO REQUEST (EMPLOYEEID, AMOUNT, REQUESTTIME, IMAGELINK, STATUS, MANAGERID) VALUES (6, 3.99, TO_TIMESTAMP('2000/5/5 05:05:00', 'YYYY/MM/DD HH:MI:SS'), 'www.validhyperlink.com/image4.png', 2, 1);
INSERT INTO REQUEST (EMPLOYEEID, AMOUNT, REQUESTTIME) VALUES (6, 4.99, TO_TIMESTAMP('2000/3/3 03:03:00', 'YYYY/MM/DD HH:MI:SS'));
